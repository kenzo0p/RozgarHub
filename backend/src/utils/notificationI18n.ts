...
const messages: Record<Language, Dict> = {
  en: {
    ...
    'welcome.employerIndividual': 'Post your first job — describe the work, your area, and the wage — and verified workers nearby can apply.',
    ...
    'application_started.title': 'Work started',
    'application_started.message': 'Your work for "{jobTitle}" has been marked as started',
    'application_started.sms': 'RozgarHub: Your work for "{jobTitle}" has started. All the best!',
    'application_completed.title': 'Work completed',
    'application_completed.message': 'Your work for "{jobTitle}" is marked complete',
    'application_completed.sms': 'RozgarHub: Your work for "{jobTitle}" is marked complete.',
    ...
    'dispute_raised.title': 'An issue was reported',
    'dispute_raised.message': 'An issue was reported on your engagement for "{jobTitle}". Please review it.',
  },
  hi: {
    ...
    'welcome.employerIndividual': 'अपनी पहली नौकरी पोस्ट करें — काम, अपना इलाक़ा और मज़दूरी बताएं — और आस-पास के सत्यापित कामगार आवेदन कर सकेंगे।',
    ...
    'application_started.title': 'काम शुरू हुआ',
    'application_started.message': '"{jobTitle}" के लिए आपका काम शुरू के रूप में चिह्नित किया गया है',
    'application_started.sms': 'RozgarHub: "{jobTitle}" के लिए आपका काम शुरू हो गया है। शुभकामनाएँ!',
    'application_completed.title': 'काम पूरा हुआ',
    'application_completed.message': '"{jobTitle}" के लिए आपका काम पूर्ण के रूप में चिह्नित है',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" के लिए आपका काम पूर्ण के रूप में चिह्नित है।',
    ...
    'dispute_raised.title': 'एक समस्या दर्ज की गई',
    'dispute_raised.message': '"{jobTitle}" के लिए आपकी सगाई पर एक समस्या दर्ज की गई है। कृपया समीक्षा करें।',
  },
  mr: {
    ...
    'welcome.employerIndividual': 'तुमची पहिली नोकरी पोस्ट करा — काम, तुमचा परिसर आणि मजुरी सांगा — आणि जवळपासचे सत्यापित कामगार अर्ज करू शकतील.',
    ...
    'application_started.title': 'काम सुरू झाले',
    'application_started.message': '"{jobTitle}" साठी तुमचे काम सुरू म्हणून चिन्हांकित केले आहे',
    'application_started.sms': 'RozgarHub: "{jobTitle}" साठी तुमचे काम सुरू झाले आहे. शुभेच्छा!',
    'application_completed.title': 'काम पूर्ण झाले',
    'application_completed.message': '"{jobTitle}" साठी तुमचे काम पूर्ण म्हणून चिन्हांकित आहे',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" साठी तुमचे काम पूर्ण म्हणून चिन्हांकित आहे.',
    ...
    'dispute_raised.title': 'एक समस्या नोंदवली गेली',
    'dispute_raised.message': '"{jobTitle}" साठी तुमच्या कामावर एक समस्या नोंदवली गेली आहे. कृपया पुनरावलोकन करा.',
  },
  bn: {
    ...
    'welcome.employerIndividual': 'আপনার প্রথম চাকরি পোস্ট করুন — কাজ, আপনার এলাকা ও মজুরি লিখুন — এবং কাছাকাছি যাচাইকৃত কর্মীরা আবেদন করতে পারবেন।',
    ...
    'application_started.title': 'কাজ শুরু হয়েছে',
    'application_started.message': '"{jobTitle}" এর জন্য আপনার কাজ শুরু হিসেবে চিহ্নিত করা হয়েছে',
    'application_started.sms': 'RozgarHub: "{jobTitle}" এর জন্য আপনার কাজ শুরু হয়েছে। শুভকামনা!',
    'application_completed.title': 'কাজ সম্পন্ন',
    'application_completed.message': '"{jobTitle}" এর জন্য আপনার কাজ সম্পন্ন হিসেবে চিহ্নিত',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" এর জন্য আপনার কাজ সম্পন্ন হিসেবে চিহ্নিত।',
    ...
    'dispute_raised.title': 'একটি সমস্যা জানানো হয়েছে',
    'dispute_raised.message': '"{jobTitle}" এর জন্য আপনার কাজে একটি সমস্যা জানানো হয়েছে। অনুগ্রহ করে পর্যালোচনা করুন।',
  },
  gu: {
    ...
    'welcome.employerIndividual': 'તમારી પ્રથમ નોકરી પોસ્ટ કરો — કામ, તમારો વિસ્તાર અને મજૂરી જણાવો — અને નજીકના ચકાસાયેલ કામદારો અરજી કરી શકશે.',
    ...
    'application_started.title': 'કામ શરૂ થયું',
    'application_started.message': '"{jobTitle}" માટે તમારું કામ શરૂ તરીકે ચિહ્નિત કરાયું છે',
    'application_started.sms': 'RozgarHub: "{jobTitle}" માટે તમારું કામ શરૂ થયું છે. શુભકામના!',
    'application_completed.title': 'કામ પૂર્ણ થયું',
    'application_completed.message': '"{jobTitle}" માટે તમારું કામ પૂર્ણ તરીકે ચિહ્નિત છે',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" માટે તમારું કામ પૂર્ણ તરીકે ચિહ્નિત છે.',
    ...
    'dispute_raised.title': 'એક સમસ્યા નોંધાવાઈ',
    'dispute_raised.message': '"{jobTitle}" માટે તમારા કામ પર એક સમસ્યા નોંધાવાઈ છે. કૃપા કરીને સમીક્ષા કરો.',
  },
  pa: {
    ...
    'welcome.employerIndividual': 'ਆਪਣੀ ਪਹਿਲੀ ਨੌਕਰੀ ਪੋਸਟ ਕਰੋ — ਕੰਮ, ਆਪਣਾ ਇਲਾਕਾ ਅਤੇ ਮਜ਼ਦੂਰੀ ਦੱਸੋ — ਅਤੇ ਨੇੜਲੇ ਪ੍ਰਮਾਣਿਤ ਕਾਮੇ ਅਰਜ਼ੀ ਦੇ ਸਕਣਗੇ।',
    ...
    'application_started.title': 'ਕੰਮ ਸ਼ੁਰੂ ਹੋਇਆ',
    'application_started.message': '"{jobTitle}" ਲਈ ਤੁਹਾਡਾ ਕੰਮ ਸ਼ੁਰੂ ਵਜੋਂ ਨਿਸ਼ਾਨਬੱਧ ਕੀਤਾ ਗਿਆ ਹੈ',
    'application_started.sms': 'RozgarHub: "{jobTitle}" ਲਈ ਤੁਹਾਡਾ ਕੰਮ ਸ਼ੁਰੂ ਹੋ ਗਿਆ ਹੈ। ਸ਼ੁਭਕਾਮਨਾਵਾਂ!',
    'application_completed.title': 'ਕੰਮ ਪੂਰਾ ਹੋਇਆ',
    'application_completed.message': '"{jobTitle}" ਲਈ ਤੁਹਾਡਾ ਕੰਮ ਪੂਰਾ ਵਜੋਂ ਨਿਸ਼ਾਨਬੱਧ ਹੈ',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" ਲਈ ਤੁਹਾਡਾ ਕੰਮ ਪੂਰਾ ਵਜੋਂ ਨਿਸ਼ਾਨਬੱਧ ਹੈ।',
    ...
    'dispute_raised.title': 'ਇੱਕ ਸਮੱਸਿਆ ਦਰਜ ਕੀਤੀ ਗਈ',
    'dispute_raised.message': '"{jobTitle}" ਲਈ ਤੁਹਾਡੇ ਕੰਮ ਉੱਤੇ ਇੱਕ ਸਮੱਸਿਆ ਦਰਜ ਕੀਤੀ ਗਈ ਹੈ। ਕਿਰਪਾ ਕਰਕੇ ਸਮੀਖਿਆ ਕਰੋ।',
  },
  ta: {
    ...
    'welcome.employerIndividual': 'உங்கள் முதல் வேலையை இடுங்கள் — வேலை, உங்கள் பகுதி, கூலியைக் குறிப்பிடுங்கள் — அருகிலுள்ள சரிபார்க்கப்பட்ட தொழிலாளர்கள் விண்ணப்பிக்கலாம்.',
    ...
    'application_started.title': 'வேலை தொடங்கியது',
    'application_started.message': '"{jobTitle}" க்கான உங்கள் வேலை தொடங்கியதாகக் குறிக்கப்பட்டுள்ளது',
    'application_started.sms': 'RozgarHub: "{jobTitle}" க்கான உங்கள் வேலை தொடங்கியது. வாழ்த்துக்கள்!',
    'application_completed.title': 'வேலை முடிந்தது',
    'application_completed.message': '"{jobTitle}" க்கான உங்கள் வேலை முடிந்ததாகக் குறிக்கப்பட்டுள்ளது',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" க்கான உங்கள் வேலை முடிந்ததாகக் குறிக்கப்பட்டுள்ளது.',
    ...
    'dispute_raised.title': 'ஒரு சிக்கல் தெரிவிக்கப்பட்டது',
    'dispute_raised.message': '"{jobTitle}" க்கான உங்கள் வேலையில் ஒரு சிக்கல் தெரிவிக்கப்பட்டுள்ளது. மதிப்பாய்வு செய்யவும்.',
  },
  te: {
    ...
    'welcome.employerIndividual': 'మీ మొదటి ఉద్యోగాన్ని పోస్ట్ చేయండి — పని, మీ ప్రాంతం, వేతనం తెలియజేయండి — సమీపంలోని ధృవీకరించబడిన కార్మికులు దరఖాస్తు చేయగలరు.',
    ...
    'application_started.title': 'పని ప్రారంభమైంది',
    'application_started.message': '"{jobTitle}" కోసం మీ పని ప్రారంభమైనట్లు గుర్తించబడింది',
    'application_started.sms': 'RozgarHub: "{jobTitle}" కోసం మీ పని ప్రారంభమైంది. శుభాకాంక్షలు!',
    'application_completed.title': 'పని పూర్తయింది',
    'application_completed.message': '"{jobTitle}" కోసం మీ పని పూర్తయినట్లు గుర్తించబడింది',
    'application_completed.sms': 'RozgarHub: "{jobTitle}" కోసం మీ పని పూర్తయినట్లు గుర్తించబడింది.',
    ...
    'dispute_raised.title': 'ఒక సమస్య నివేదించబడింది',
    'dispute_raised.message': '"{jobTitle}" కోసం మీ పనిపై ఒక సమస్య నివేదించబడింది. దయచేసి సమీక్షించండి.',
  },
};
